    ...
    <>
      <div className="waiver_container">
        ...
        <div className="text">
          <h2>waiver</h2>
          <div className="rules">
            <h4>R E A D C A R E F U L LY</h4>
            <h5>
              ...
              includes all claims based on negligence, action or inaction of the
              above parties. <br />
              <br />
              ...
              your safe participation. Play at you own risk, bu please: watch
